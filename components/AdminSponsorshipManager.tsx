...
function gameLabel(game:GameType){return game==='classic'?'Classic GeoWeedo':game==='daily'?'Daily Weedo':game==='hunt'?'Weedo Hunt':'Sponsored Mission';}
const DEFAULT_PRODUCTS:GameProducts={classic:{name:'Classic Sponsor',dayPriceCents:1000,weekPriceCents:4900,monthPriceCents:14900},daily:{name:'Daily Weedo Sponsor',dayPriceCents:1500,weekPriceCents:7900,monthPriceCents:24900},hunt:{name:'Sponsored Weedo Hunt',weekPriceCents:9900,monthPriceCents:29900},mission:{name:'Sponsored GeoWeedo Mission'}};
