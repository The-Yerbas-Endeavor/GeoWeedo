...
export default function MapScannerSearchPlacement() {
  ...
  // The scanner button is already rendered inside the unified search control.
  // Do not move it with DOM mutations: re-parenting React-owned elements can
  // break focus/input handling in the controlled search field.
