...
export default function HomePlayCardEnhancer() {
  useEffect(() => {
    ...
    const enhance = () => {
      ...
      const brand = document.createElement('div'); brand.className = 'home-promo-brand'; brand.innerHTML = '<img src="/assets/geoweedo/geoweedo-icon-96.png" alt="GeoWeedo mascot" class="home-promo-mascot"/><div class="home-promo-wordmark"><span>Geo</span><strong>Weedo</strong></div>';
