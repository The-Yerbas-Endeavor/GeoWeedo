...
const liveModules:ModuleCard[]=[
  ...
  {title:'Weedo Facts COA review',description:'Review submitted SC Labs COA PDFs, promote approved evidence, and refresh Product Chemistry and cultivar/genetics data sources.',href:'/admin/weedo-facts',status:'live',action:'Review COAs',secondaryHref:'/admin/weedo-facts/sources',secondaryAction:'Update sources',permission:'data.manage'},
  {title:'Cultivar genetics',description:'Curate canonical cultivars, aliases, breeder/source evidence, pedigree claims, product links, and measured genetic relationships.',href:'/admin/cultivar-genetics',status:'live',action:'Manage cultivar pedigree',permission:'data.manage'},
  ...
  return <main className={styles.shell}>
    ...
    <section className={styles.section}>
      ...
      <div className={styles.grid}>
        {ownerMode&&<article className={styles.card}><div className={styles.cardTop}><span className={styles.liveBadge}>LIVE</span><h3>My dispensary</h3></div><p>Edit your verified shop profile and scan canonical Weedo Facts products directly into the menu for your assigned dispensary.</p><div className={styles.cardActions}><a className={styles.primaryLink} href="/admin/my-dispensary">Manage my shop & menu</a></div></article>}
