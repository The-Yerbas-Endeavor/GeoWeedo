...
const liveModules:ModuleCard[]=[
  ...
  {title:'Products & menus',description:'Create canonical cannabis products, add UPC/EAN identifiers, and publish product availability to verified dispensary menus.',href:'/admin/products-menus',status:'live',action:'Manage products & menus',permission:'data.manage'},
