...
const liveModules:ModuleCard[]=[
  ...
  {title:'Weedo Facts COA review',description:'Review submitted SC Labs COA PDFs and promote approved evidence into verified exact-batch Weedo Facts records.',href:'/admin/weedo-facts',status:'live',action:'Review COAs',permission:'data.manage'},
