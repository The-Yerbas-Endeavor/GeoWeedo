...
`}</style><main className="admin-shell"><header className="admin-header"><div><a href="/admin" className="eyebrow" style={{textDecoration:'none',color:'inherit'}}>GEOWEEDO ADMIN</a><h1>Dispensaries</h1><p style={{color:'var(--muted)'}}>Street View readiness is now checked automatically during approval. Google 360° imagery is immediately game-ready; fallback imagery must still meet movement-quality rules.</p></div><div className="admin-links"><a href="/admin">Control center</a><a href="/admin/data">Data import</a><a href="/admin/community">Community</a><a href="/">Game</a></div></header><div className="quick-approval"><AdminDispensaryQuickApprove/></div><AdminBatchEnrichmentQueue/><details><summary style={{cursor:'pointer',margin:'8px 0 14px'}}>Single-record discovery / enrichment tools</summary><AdminOfficialSiteDiscovery/><AdminDispensaryEnrichment/></details><AdminFullDispensaryEditor/></main><AdminStateGroupsPortal/></div>}
