...
export const metadata = {
  ...
  description: 'Scan cannabis products and understand batch-level lab results in a consumer-friendly GeoWeedo Facts format.',
  alternates: { canonical: '/geoweedo-facts' },
};

export default function GeoWeedoFactsPage() {
  return (
      ...
      <div className="weedoFactsPage">
        ...
        <section className="weedoFactsRoadmap">
          ...
          <ol>
            ...
            <li><strong>Present:</strong> show a consistent GeoWeedo Facts panel while preserving the original lab/COA source.</li>
          </ol>
        </section>
      </div>
    </main>
