...
type SyncDetail={ok:boolean;source:string;fetched:number;added:number;existing:number;filled:number;fieldsFilled:number;geocoded:number;duplicates?:number;total?:number;error?:string};
