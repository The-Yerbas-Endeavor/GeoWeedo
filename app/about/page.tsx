  ...
  return (
    <main className="info-shell">
      ...
      <section className="info-grid two-col">
        <article><span className="eyebrow">PLAY</span><h2>Three GeoWeedo game modes</h2><p><strong>Classic GeoWeedo</strong> is the five-round geography game. <strong>Weedo Hunt</strong> turns a real dispensary into a hot-and-cold search challenge. <strong>Daily Weedo</strong> gives everyone the same daily location and one shared challenge.</p></article>
        ...
        <article><span className="eyebrow">FEATURED</span><h2>Commercial sponsorships are USD-only</h2><p>Business claiming and profile management are free. GeoWeedo Featured and clearly labeled game sponsorships are priced and managed in U.S. dollars. YERB is not used for sponsorship payments, and sponsorship never increases a dispensary&apos;s odds of becoming a normal Classic, Daily or Weedo Hunt target.</p></article>
