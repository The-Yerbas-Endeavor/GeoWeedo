  ...
  return (
    <main className="info-shell">
      ...
      <section className="info-grid two-col">
        ...
        <article><h2>Know what people use</h2><p>The Sponsor Dashboard tracks map impressions, pin clicks, listing views, website/menu/directions actions, game impressions and game completions over the last 30 days.</p></article>
