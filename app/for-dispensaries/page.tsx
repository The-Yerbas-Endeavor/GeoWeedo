  ...
  return (
    <main className="info-shell">
      ...
      <section className="info-grid two-col">
        ...
        <article><h2>🌎 Daily GeoWeedo Sponsor</h2><p>Reserve the clearly labeled Daily presented-by placement for a day, week or month. The shared Daily location remains deterministic and independent of sponsorship. Introductory pricing starts at $15/day, $79/week or $249/month.</p></article>
        <article><h2>🌿 Sponsored GeoWeedo Hunt</h2><p>Run a clearly branded Hunt campaign that can grow into regional events, promotions and redemption-based challenges. Normal Hunt target selection remains independent. Introductory pricing starts at $99/week or $299/month.</p></article>
